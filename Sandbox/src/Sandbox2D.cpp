...
void Sandbox2D::OnAttach()
{
	...
	m_CheckerboardTexture = Endeavor::Texture2D::Create("assets/textures/Checkerboard.png");

	Endeavor::FramebufferSpecification fbSpec;
	fbSpec.Width = 1280;
	fbSpec.Height = 720;
	m_Framebuffer = Endeavor::Framebuffer::Create(fbSpec);
}
...
void Sandbox2D::OnUpdate(Endeavor::Timestep ts)
{
	...
	}
	{
		...
		Endeavor::Renderer2D::DrawQuad({ 0.0f,  0.0f, -0.1f }, { 20.0f, 20.0f }, m_CheckerboardTexture, 10.0f);
		Endeavor::Renderer2D::DrawRotatedQuad({ -2.0f, 0.0f, 0.0f }, { 1.0f, 1.0f }, glm::radians(rotation), m_CheckerboardTexture, 20.0f);
	...
	if (dockingEnable)
	{
		...
		if (ImGui::BeginMenuBar())
		{
			if (ImGui::BeginMenu("File"))
			{
				...
				{
					Endeavor::Application::Get().Close();
					dockspaceOpen = false;
				}
